...
def primera_pantalla():
    ...
    boton_registro = Button(inicio, text="Ingrese usuario y contraseña", width=25)
...
def pantalla_menú():
    ...
    ventana_secundaria.title("Pantalla de menu")
    ventana_secundaria.geometry("600x600")
    
    # Cargar la imagen y mostrarla en un widget Label
    ruta_imagen = "foto3.jpg"  # Asegúrate de proporcionar la ruta correcta y el nombre de la imagen
    imagen = Image.open(ruta_imagen)
    ...
    # Agrega aquí los elementos de la segunda pantalla
